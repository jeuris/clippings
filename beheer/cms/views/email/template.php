	...
	<tr>
		...
		<tr>
			<td bgcolor="#000000" width="600" class="promocell">                      
				...
				<multiline label="Main feature intro"><p>account information</p></multiline>
				...
				<td width="100%" bgcolor="#ffffff">
					...
					<tr>
						<td bgcolor="#ffffff" class="contentblock">
							...
							<multiline label="Description"><p><?php print $content; ?> <?php echo Html::anchor('../', 'Go to clippings.'); ?></p></multiline>
						</td>
					</tr>
					</table>
				...
				<td width="100%" bgcolor="#ffffff">
					...
					<tr>
						<td bgcolor="#ffffff" class="contentblock">
							...
							<h4 class="secondary"><strong><singleline label="Title">Account information.</singleline></strong></h4>
							<multiline label="Description">
								<p><strong>Username.</strong> <?php echo $name; ?><br /><strong>password.</strong> <?php echo $password; ?></p>
