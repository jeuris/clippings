$('document').ready(function() {
  ...
  {
    if (!timer) {
      timer = setTimeout(doSomething, 200); // Or whatever value you want
    }
  ...
  function doSomething()
  {
    ...
    {
      if($('#clippingModal').length)
      {

        $('#clippingModal').remove();
      }

      $('#overlay').css({'display' : 'block'});
      //$('#modal1').show();

        $('#modalcontainer').prepend('<div class="box"">');
        $('.box').append('<div class="box-content">');
        $('.box .box-content').append('<p style="margin-bottom:0px">One moment please</p>');

        $('#modalcontainer').css({'width' : '150px'});
        $('.box .box-content p').css({'margin-bottom' : '0px'});
    }
  };
  ...
  ********************/
  ...
  $('body').prepend('<div id="overlay"><div id="modalcontainer"></div></div>');
    ...
    //<div class="box-header><h1>Uploading</h1></div><div class="box-content"><p>one moment please</p></div></div>');
